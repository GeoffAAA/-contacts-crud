<div class="fixed inset-0 z-50 flex items-center justify-center">
    ...
    <div class="relative z-10 w-full max-w-lg mx-auto bg-white rounded-lg shadow-lg">
        <div class="flex items-center justify-between px-5 py-4 border-b">
            <h3 class="text-lg font-semibold">{{ $contactId ? 'Edit Contact' : 'Add Contact' }}</h3>
            <button type="button" wire:click="$dispatch('contactSaved')" class="text-gray-500 hover:text-gray-700">✕</button>
        </div>
        <div class="p-5">
            <form wire:submit.prevent="save" class="space-y-4">
                ...
                <div class="flex items-center justify-end space-x-2 pt-2">
                    <button type="button" wire:click="$dispatch('contactSaved')" class="px-4 py-2 rounded border border-gray-300 text-gray-700 hover:bg-gray-50">Cancel</button>
